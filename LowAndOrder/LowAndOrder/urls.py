...
urlpatterns = [
    ...
    path('index/',TemplateView.as_view(template_name="test3.html")),
    ...
    path('detecreport/',views.DetecReport),
    path('citizreport/',views.CitizReport),
    path('findreport/',views.findReport),
    path('finddetecreport/',views.findDetecReport),
    path('findcitizreport/',views.findCitizReport),
]
